        ...
        $result = /** @lang JavaScript */
                ...
                if (args) {
                    ...
                    for (let p in args) {
                        ...
                        else if (p === 'connectionString') command[p] = CryptoJSAesJson.decrypt(args[p], passPhrase);
                        else if (p === 'queryString') command[p] = CryptoJSAesJson.decrypt(args[p], passPhrase);
